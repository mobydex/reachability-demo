    ...
    extends VerticalLayout
{
    ...
    public GeoSparqlView(AppState appState) {
        ...
        Map<Var, Node> substitutions = Map.of(Var.alloc("GRID_WKT"), gridNode);
    ...
    public void setProjectEnvelope(Geometry geom) {
        ...
        projectGridLayer.addLayer(layer);
    }
